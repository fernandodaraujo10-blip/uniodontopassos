...
export const App: React.FC = () => {
  ...
  return (
    <DashboardProvider>
      <div className="flex min-h-[100dvh] md:h-screen w-full overflow-hidden bg-[#F8F9FA] antialiased">
        ...
        <main className="mobile-page flex-grow flex flex-col min-h-[100dvh] overflow-x-hidden overflow-y-auto pb-[calc(96px+env(safe-area-inset-bottom,0px))] md:pb-0">
