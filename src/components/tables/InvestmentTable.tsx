...
import MobileInvestmentList from './MobileInvestmentList';
...
export const InvestmentTable: React.FC<InvestmentTableProps> = ({
  ...
  return (
    <>
      {/* ── MOBILE: usar lista de cards (renderizado pelo Dashboard.tsx via MobileInvestmentList) ── */}
      {/* Este componente é usado APENAS no layout desktop — o mobile usa MobileInvestmentList diretamente */}
